...
RSpec.describe Rental do
  ...
  describe '#day_fee' do
    it 'testing day_fee method' do
      expect(rental_object.day_fee).to be_an Integer
    end
  end

  describe '#discounts_days' do
    it 'testing discounts_days method' do
      expect(rental_object.discounts_days).to eq discount_calcul
    end
  end
end